          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                {[
                  { user: "Sarah Johnson", action: "logged in", time: "2 mins ago" },
                  { user: "Michael Chen", action: "updated profile", time: "15 mins ago" },
                  { user: "James Wilson", action: "created new project", time: "1 hour ago" },
                  { user: "Admin", action: "invited Lisa Thompson", time: "3 hours ago" },
                ].map((activity, index) => (
