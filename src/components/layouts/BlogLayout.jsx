...
export default function BlogLayout() {
  ...
  const featuredPost = {
    ...
    excerpt: "Learn how to create maintainable, type-safe design systems that scale with your team and product. We'll explore best practices, common pitfalls, and real-world examples.",
    author: {
      name: "Sarah Chen",
  ...
  const posts = [
    {
      ...
      excerpt: "Explore the emerging technologies and practices shaping the future of web development.",
      author: {
        name: "Alex Kumar",
    ...
    },
    {
      ...
      excerpt: "Dive deep into CSS Grid with practical examples and learn how to create complex layouts effortlessly.",
      author: {
        name: "Maria Garcia",
        avatar: "https://i.pravatar.cc/150?u=maria",
      },
      coverImage: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=600&h=300&fit=crop",
      category: "CSS",
    ...
    },
    {
      ...
      excerpt: "A comprehensive guide to the new App Router in Next.js 14 with practical examples.",
      author: {
        name: "Emily Zhang",
        avatar: "https://i.pravatar.cc/150?u=emily",
      },
      coverImage: "https://images.unsplash.com/photo-1517180102446-f3ece451e9d8?w=600&h=300&fit=crop",
      category: "Next.js",
    ...
    },
    {
      ...
      excerpt: "Discover the principles and practices that lead to maintainable, readable, and efficient code.",
      author: {
        name: "David Park",
        avatar: "https://i.pravatar.cc/150?u=david",
      },
      coverImage: "https://images.unsplash.com/photo-1516116216624-53e697fedbea?w=600&h=300&fit=crop",
  ...
  const popularTags = [
    ...
    "Design Systems", "Performance", "Web Dev", "Tutorial", "Best Practices"
  ]
