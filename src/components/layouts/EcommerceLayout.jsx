            ...
            {features.map((feature, index) => {
              ...
              return (
                <div key={index} className="flex items-center gap-2 text-sm">
                  ...
                  <span className="text-muted-foreground hidden sm:inline">- {feature.description}</span>
                </div>
              )
            })}
          </div>
        ...
        <div className="container mx-auto px-4">
          <Card className="max-w-2xl mx-auto">
            <CardHeader className="text-center">
              ...
              <CardDescription>Get the latest products and exclusive offers delivered to your inbox</CardDescription>
            </CardHeader>
            <CardContent>
