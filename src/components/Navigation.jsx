...
import { ArrowLeft, Layout, FileCode, Download, Menu, X } from 'lucide-react'
    ...
    <div className="border-b">
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center gap-2 text-sm sm:text-lg font-semibold hover:text-primary-500 transition-colors">
